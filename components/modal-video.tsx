...
import FeaturesBg2 from 'components/video_thumbnail.png'
      ...
      <div>
        <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
          <div className="flex flex-col justify-center">
            <Image src={FeaturesBg2} width={thumbWidth} height={thumbHeight} alt={thumbAlt} />
          ...
          <button className="absolute top-full flex items-center transform -translate-y-1/2 bg-white rounded-full font-medium group p-4 shadow-lg" onClick={() => { setModalOpen(true) }}>
            ...
            <span className="ml-3">Take a look at the Basic implementation of the tool</span>
          </button>
        </div>
      </div>
      {/* End: Video thumbnail */}
